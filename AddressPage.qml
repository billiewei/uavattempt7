...
Rectangle {
    ...
    Text {
        ...
        anchors.topMargin: page.height*.08
        width: page.width
    ...
    TextField {
        ...
        maximumLength: 100
        anchors.horizontalCenter: parent.horizontalCenter
        y: currentcustomername.y + page.height*.1 //0.12
        width: page.width
        height: page.height*.09    //0.1
        placeholderText: qsTr("Street")
    }
    TextField {
        id: currentcustomercity
        anchors.horizontalCenter: parent.horizontalCenter
        y: currentcustomerstreet.y + page.height*.1 //0.12
        width: page.width
        height: page.height*.09      //0.1
    ...
    TextField {
        ...
        y: currentcustomercity.y + page.height*.1  //0.12
    ...
    TextField {
        ...
        y: currentcustomerzipcode.y + page.height*.1  //0.12
        width: page.width
        height: page.height*.09    //0.1
    }
    TextField {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        y: currentcustomercountry.y + page.height*.1   //0.12
        width: page.width
        height: page.height*.09   //0.1
    ...
    TextField {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        maximumLength: 14
        y: currentcustomeremail.y + page.height*.1   //0.12
        width: page.width
        height: page.height*.09   //0.1
    ...
    Button {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        y: currentcustomerphone.y + page.height*.05 //0.1   //0.12
    ...
    Rectangle {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        y: currentcustomerphone.y + page.height*.1   //0.12
    ...
    Button {
        id: backButton3
        anchors.horizontalCenter: parent.horizontalCenter
        y: submitaddressButton.y + page.height*.05
        width: page.width * 0.5
       // height: page.height * 0.09
        text: "Back"
        onClicked:{
            address_page.visible = false
